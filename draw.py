...
img_player_iconic = pygame.image.load(os.path.join(img_folder, 'drone_1_blue.png'))
# Font
...
class dialogue():
    def __init__(self, screen, Text, x, y, width, height, color_botton, color_text, draw_condition):
        ...
        if self.draw_condition:
            ...
            botton_text = text_dialogue(screen, self.Text, 20, self.x, self.y, self.color_text)
